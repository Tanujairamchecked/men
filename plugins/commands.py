...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('𝙿𝚁𝙸𝚅𝙰𝚃𝙴 𝙱𝙾𝚃', url=f"https://t.me/@Lillyfilter_bot")
            ]
            ]
    ...
    if len(message.command) != 2:
        ...
        reply_markup = InlineKeyboardMarkup(buttons)        
        await message.reply_photo( #photo or video
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
       #reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('subscribe', url='https://youtube.com/channel/UCl1EnIFvBwT7dPtgfOYnvPA')]]),
        protect_content=True if pre == 'filep' else False,
        )
